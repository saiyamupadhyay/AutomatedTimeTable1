            ...
            <table border="0" class="logintable">
                <tbody>
                    <tr>
                        ...
                        <td><input type="text" name="sid" value="" size="20" placeholder="Teacher Id" /></td>
                    </tr>
                    <tr>
                        
                        <td><input type="password" name="spassword" value="" size="20" placeholder="Password" /></td>
                    </tr>
                    <tr>
                        
                        <td><input type="text" name="sinst" value="" size="20" placeholder="Institution"/></td>
                    </tr>
                </tbody>
            </table>
            <div class="button">
